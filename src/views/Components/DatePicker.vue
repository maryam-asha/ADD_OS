	...
	<div class="page">
		...
		<div class="components-list">
			<CardCodeExample title="Basic">
				...
				<n-date-picker v-model:value="timestamp" :type clearable />
			...
			<CardCodeExample title="Shortcuts">
				...
				<n-date-picker v-model:value="ts1" type="date" :shortcuts />
				<template #code="{ html, js }">
					{{ html(`
					<div>
			...
			<CardCodeExample title="Format">
				<n-date-picker v-model:value="timestamp" type="datetime" clearable :format />
				<template #code="{ html, js }">
					{{ html(`
					<div>
...
const timestamp = ref<Value>(Date.now())
const type = ref<DatePickerType>("date")
const typeOptions = [
	{
		label: "Date",
