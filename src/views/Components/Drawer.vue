	...
	<div class="page">
		...
		<div class="components-list">
			<CardCodeExample title="Basic">
				...
				<n-drawer v-model:show="active" :placement resizable :default-width="502">
					...
					<n-drawer v-model:show="showInner" :width="251" :placement>
...
import { NButton, NButtonGroup, NDrawer, NDrawerContent, NText } from "naive-ui"
import { ref } from "vue"
...
function activate1(place: DrawerPlacement) {
	active1.value = true
	placement.value = place
}
</script>
