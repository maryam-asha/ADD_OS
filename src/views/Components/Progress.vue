	...
	<div class="page">
		...
		<div class="components-list">
			<CardCodeExample title="Circle">
				...
				<n-space vertical>
					<n-space>
						<n-progress type="circle" :percentage />
						<n-progress type="circle" status="info" :percentage />
						<n-progress type="circle" status="success" :percentage />
						<n-progress type="circle" status="warning" :percentage />
						<n-progress type="circle" status="error" :percentage />
					</n-space>
					<n-space>
			...
			<CardCodeExample title="Line">
				...
				<n-space vertical>
					...
					<n-progress type="line" status="success" :percentage="percentage1" indicator-placement="inside" />
					...
					<n-progress type="line" status="warning" :percentage="percentage1" indicator-placement="inside" />
