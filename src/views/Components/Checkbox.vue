		...
		<div class="components-list">
			<CardCodeExample title="Basic">
				<n-space item-style="display: flex;" align="center">
					...
					<n-checkbox v-model:checked="value" :disabled>Checkbox</n-checkbox>
			...
			<CardCodeExample title="Indeterminate">
				<n-space item-style="display: flex;" align="center">
					<n-checkbox v-model:checked="value" :indeterminate>checkbox</n-checkbox>
					<n-checkbox v-model:checked="value" :indeterminate />
					<n-checkbox v-model:checked="value" :indeterminate disabled />
